...
void Engine::init()
{
    ...
    texturedVectorShader.addShader(GL_VERTEX_SHADER, "shaders/vertex/passthrough.vert");
    texturedVectorShader.addShader(GL_FRAGMENT_SHADER, "shaders/fragment/rgbafromtex0.frag");
    texturedVectorShader.addShader(GL_TESS_CONTROL_SHADER, "shaders/tesselation/3vertpatch.tesscont");
    texturedVectorShader.addShader(GL_TESS_EVALUATION_SHADER, "shaders/tesselation/3vertpatch.tesseval");
    // Link the shader
    ...
    catTexture = loadTexture("textures/cat.png");
    ////////////////////////////////////////////////////////////
    // Setup the lighting
...
void Engine::loop( int width, int height )
{
    ...
    mat4x4_translate_in_place(m, -viewCenter[0], viewCenter[1], 0.0f);

    // Bottom-left, Top-right
    // Near plane, far plane
    //mat4x4_ortho(p, -180.0f, 180.0f, -90.0f, 90.0f, 1.0f, -1.0f);
    mat4x4_ortho(p, viewExtent[0], viewExtent[1], viewExtent[2], viewExtent[3], 360.0f, -360.0f);
    ...
    glUniform3fv(texturedVectorShader.uniform("light.ambient.color"), 1, light.ambient.color);
